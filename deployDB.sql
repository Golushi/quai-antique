...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 27 mars 2023 à 20:37
...
(145, 'stef', 2, '2023-03-22', '19:00:00', 0, 0, 0, 1, ''),
(147, 'paul', 7, '2023-03-24', '21:00:00', 0, 0, 0, 0, 'rien'),
(148, 'stecy', 8, '2023-03-24', '21:00:00', 0, 0, 0, 0, ''),
(150, 'test4', 3, '2023-03-24', '19:00:00', 0, 0, 0, 0, ''),
(151, 'admin', 1, '2023-03-24', '19:00:00', 1, 1, 1, 1, ''),
(152, 'gandalf', 2, '2023-03-24', '19:00:00', 0, 0, 0, 0, ''),
(153, 'Rident', 2, '2023-03-26', '19:00:00', 0, 0, 0, 0, '');
...
(23, 56, 'admin', 5, 0, 0, 0, 1, ''),
(74, 116, 'test', 5, 0, 1, 0, 0, ''),
(96, 134, 'Jean', 5, 0, 0, 1, 0, ''),
(165, 166, 'kelly', 4, 0, 0, 0, 0, '');
...
INSERT INTO `opening_hours` (`id`, `day`, `lunch_start`, `lunch_end`, `dinner_start`, `dinner_end`) VALUES
(8, 'Monday', '12:00:00', '14:30:00', '19:00:00', '23:00:00'),
(9, 'Tuesday', '12:00:00', '14:30:00', '19:00:00', '23:00:00'),
(10, 'Wednesday', '12:00:00', '14:30:00', '19:00:00', '23:00:00'),
(11, 'Thursday', '12:00:00', '14:30:00', '19:00:00', '23:00:00'),
(12, 'Friday', '12:00:00', '14:30:00', '19:00:00', '00:00:00'),
(13, 'Saturday', '12:00:00', '15:00:00', '19:00:00', '00:00:00'),
(14, 'Sunday', '12:00:00', '15:00:00', '19:00:00', '00:00:00');
...
(166, 'kelly', 'd574865dc1cfefc39a1d625eb16d69cde4d860c8e1ef992b0e991bbd51900d3a', '$2b$10$IlksktMnV4TpY03m5ltrmuwy27EbAI15Bi6LYG51FVK1GEJ1Fj.y2', NULL, 4, '2023-03-27 19:00:58');
...
--
ALTER TABLE `booking`
  MODIFY `id_reservation` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=162;

--
-- AUTO_INCREMENT pour la table `fiche_user`
--
ALTER TABLE `fiche_user`
  MODIFY `id_fiche_user` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=166;
