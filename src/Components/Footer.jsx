...
export default function Footer() {
  return (
    <footer id='contact' className='bg-myblue z-10 font-oswald w-screen h-auto grid grid-row-4 justify-center'>
      ...
      <a href="https://www.facebook.com/" role="button" target='_blank'>
        <svg
      ...
      <a href="https://www.instagram.com/" role="button" target='_blank'>
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://www.twitter.com" role="button" target='_blank'>
        <svg
          xmlns="http://www.w3.org/2000/svg"
