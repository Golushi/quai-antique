...
export default function Footer() {
  return (
    <footer id='contact' className='bg-myblue z-10 font-oswald w-screen h-auto grid grid-row-4 justify-center'>
      ...
      <div className='gap-5 my-5 flex justify-between'>
      <a href="https://www.facebook.com/" role="button" target='_blank' rel="noreferrer">
        <svg
      ...
      <a href="https://www.instagram.com/" role="button" target='_blank' rel="noreferrer">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-10 w-10 text-[#c13584]"
          fill="currentColor"
          viewBox="0 0 24 24">
          <path
      ...
      <a href="https://www.twitter.com" role="button" target='_blank' rel="noreferrer">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-10 w-10 text-[#1da1f2]"
          fill="currentColor"
          viewBox="0 0 24 24">
          <path
