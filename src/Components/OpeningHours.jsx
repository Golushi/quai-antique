      ...
      <div className="w-2/3 min-w-[260px] md:w-[500px] h-auto flex-container m-auto px-5">
        ...
        <div className="grid font-oswald grid-cols-2">
          <div className="grid justify-items-start my-2">
            <p className="text-myyellow h-20 items-center transform duration-500 hover:scale-125 flex my-2">Lundi</p>
            <p className="text-myyellow h-20 items-center transform duration-500 hover:scale-125 flex my-2">Mardi</p>
            <p className="text-myyellow h-20 items-center transform duration-500 hover:scale-125 flex my-2">
              Mercredi
            </p>
            <p className="text-myyellow h-20 items-center transform duration-500 hover:scale-125 flex my-2">Jeudi</p>
            <p className="text-myyellow h-20 items-center transform duration-500 hover:scale-125 flex my-2">
              Vendredi
            </p>
            <p className="text-myyellow h-20 items-center transform duration-500 hover:scale-125 flex my-2">Samedi</p>
            <p className="text-myyellow h-20 items-center transform duration-500 hover:scale-125 flex my-2">
              Dimanche
            </p>
          </div>
