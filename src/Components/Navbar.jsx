...
export default function Navbar() {
    ...
    return (
<nav id="navbar" className="bg-black opacity-80 border-gray-200 px-2 sm:px-4 py-2.5 sticky top-0">
  <div className="container flex flex-wrap items-center justify-between mx-auto">
    ...
    type="button" 
    className="inline-flex items-center p-2 ml-3 text-sm text-white animate-pulse" 
